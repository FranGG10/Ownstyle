  ...
  try {
    const facturas = await sql`
      SELECT
        ...
        f.cae, f.cae_vencimiento, f.imp_neto, f.imp_iva, f.importe_total, f.fecha_emision,
        m.fecha as fecha_venta, m.numero_comprobante as venta_numero_comprobante,
      ...
      WHERE f.fecha_emision >= ${desde}::date AND f.fecha_emision <= ${hasta}::date
